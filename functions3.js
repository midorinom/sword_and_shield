...
function endgameScreen(won = false) {
  ...
  // If the player won
    ...
    document.querySelector("#endgame_title").innerText =
...
function changeParryTimer() {
  ...
  document.querySelector("#change_parry_timer_container").style.display =
    "flex";
  ...
  document
    .querySelector("#change_parry_timer_setting_button1")
    .addEventListener("click", setParryTimerClassic);
  document
    .querySelector("#change_parry_timer_setting_button2")
    .addEventListener("click", setParryTimerNormal);
  document
    .querySelector("#change_parry_timer_setting_button3")
    .addEventListener("click", setParryTimerEasy);
}
...
function removeSetParryTimerEvents() {
  document
    .querySelector("#change_parry_timer_setting_button1")
    .removeEventListener("click", setParryTimerClassic);
  document
    .querySelector("#change_parry_timer_setting_button2")
    .removeEventListener("click", setParryTimerNormal);
  document
    .querySelector("#change_parry_timer_setting_button3")
    .removeEventListener("click", setParryTimerEasy);
}
